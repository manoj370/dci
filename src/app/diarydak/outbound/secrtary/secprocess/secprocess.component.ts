...
@Component({
  selector: 'app-secprocess',
  templateUrl: './secprocess.component.html',
  styleUrls: ['./secprocess.component.scss']
})
export class SecprocessComponent implements OnInit ,OnDestroy {
  canonicalData: any = [];
