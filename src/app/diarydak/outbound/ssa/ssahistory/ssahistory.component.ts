...
@Component({
  selector: 'app-ssahistory',
  templateUrl: './ssahistory.component.html',
  styleUrls: ['./ssahistory.component.scss']
})
export class SsahistoryComponent implements OnInit ,OnDestroy {
  canonicalData: any = [];
